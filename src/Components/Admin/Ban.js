...
const Ban = (props) => {
    ...
    const handleSubmit=(e)=>{
        ...
        {
            console.log(update)
            axios.post(`http://127.0.0.1:8000/api/ban/${userID}`,update)
            .then(resp=>{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" id="exampleFormControlTextarea1" rows="3" name="verified" defaultValue="banned" onChange={handleChange} onMouseOver={mount} hidden/>
                {/* <p style={{color: "red"}}>{descErr}</p> */}
              </div>

              <input type="submit" name="submit" value="Ban" className="btn btn-primary login_button"/>
          </form>  
        </div>
        </div>
    );
